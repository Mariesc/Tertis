...
public class MatriceL2 extends Matrice{
    ...
    public MatriceL2(){}
    public MatriceL2(ArrayList<Integer> ListCase, int choixBarre, int couleurRandom){
