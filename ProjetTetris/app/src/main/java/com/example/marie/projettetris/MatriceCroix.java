...
public class MatriceCroix extends Matrice{
    ...
    public MatriceCroix(){}
    public MatriceCroix(ArrayList<Integer> ListCase, int choixBarre, int couleurRandom){
        ...
        ListCoordBarre3.add(14);
        ListCoordBarre3.add(9);

        ListCoordBarre4.add(6);
        ListCoordBarre4.add(9);
        ListCoordBarre4.add(10);
        ListCoordBarre4.add(11);
