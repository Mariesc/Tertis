...
public class MatriceDiag2 extends Matrice{
    ...
    public MatriceDiag2(ArrayList<Integer> ListCase, int choixBarre,int couleurRandom){
        ...
        ListCoordBarre1.add(11);

        ListCoordBarre2.add(13);
